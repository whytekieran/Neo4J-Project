// Referenced as query 25 in QueryData.cypher this query will return how many Candidate nodes represent each political party (So must count the 'MEMBER_OF' relationships)
